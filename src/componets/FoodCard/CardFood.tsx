...
@observer
class CardFood extends React.Component<{product: IProduct, addToCart: (e: IProduct, ) => void}> {
    render() {
         return(
            <Card className={styles.foodCard}>
                <div className={styles.cardBlock}>
                    <div className={styles.infBlock}>
                        ...
                        <Card.Title className={styles.costBlock}>{this.props.product.price} Руб</Card.Title>
                    ...
                    <div className={styles.addInfBlock}>
                        <Button onClick={() => this.props.addToCart(this.props.product)} variant={''} bsPrefix={''} className={styles.cardButton}><p className={styles.text}>+</p><p className={styles.textAdd}>Добавить</p></Button>
                    </div>
                </div>
            </Card>
        )
